...
static menuitem_t OP_ScreenshotOptionsMenu[] =
{
	...
	{IT_STRING|IT_CVAR, NULL, "Memory Level",      &cv_zlib_memory,                32},
	{IT_STRING|IT_CVAR, NULL, "Compression Level", &cv_zlib_level,                 37},
	{IT_STRING|IT_CVAR, NULL, "Strategy",          &cv_zlib_strategy,              42},
	{IT_STRING|IT_CVAR, NULL, "Window Size",       &cv_zlib_window_bits,           47},

	{IT_HEADER, NULL, "Movie Mode (F9)", NULL, 67},
	{IT_STRING|IT_CVAR, NULL, "Storage Location",  &cv_movie_option,               73},
	{IT_STRING|IT_CVAR|IT_CV_STRING, NULL, "Custom Folder", &cv_movie_folder, 	   78},
	{IT_STRING|IT_CVAR, NULL, "Capture Mode",      &cv_moviemode,                  84},

	{IT_STRING|IT_CVAR, NULL, "Downscaling",       &cv_gif_downscale,              89},
	{IT_STRING|IT_CVAR, NULL, "Region Optimizing", &cv_gif_optimize,              94},
	{IT_STRING|IT_CVAR, NULL, "Local Color Table", &cv_gif_localcolortable,       100},
	{IT_STRING|IT_CVAR|IT_CV_SLIDER, NULL, "Max GIF Size (MB)",      &cv_gif_maxsize,  105},
	{IT_STRING|IT_CVAR, NULL, "Keep recording when capped",      &cv_gif_rolling_buffer,  	  111},
};
