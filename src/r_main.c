...
static CV_PossibleValue_t menubg_cons_t[] = {{0, "MIN"}, {255, "MAX"}, {0, NULL}};
...
consvar_t cv_menubgcolor = CVAR_INIT ("menubgcolor", "159", CV_SAVE|CV_CALL|CV_CLIENT, menubg_cons_t, NULL);
